...
Note: `cache/sample-fingerprint.json` is unrelated to this working set — it fingerprints the *full* installed `Examples/` directory and is regenerated by `scripts/inspect_samples.py --fingerprint`.
