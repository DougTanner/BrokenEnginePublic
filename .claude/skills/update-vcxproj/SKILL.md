...
Read `Projects/BrokenEngineSandbox/Platforms/VisualStudio2026/CLAUDE.md` first — the authoritative rule source (inclusion rules, filter-path mirroring, affinity naming conventions, shader handling). Orientation summary:
