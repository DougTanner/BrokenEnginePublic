...
- The replay manifest is the generation commit marker. Recording start invalidates it before replacing any component; recording stop publishes a valid manifest only after writers and metadata succeed. Playback validates it before reading components.
