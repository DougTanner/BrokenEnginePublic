...
void CommandPing([[maybe_unused]] const nlohmann::json& rParams, nlohmann::json& rResult)
{
...
#endif
	rResult["tick"] = gpGame != nullptr ? gpGame->TickCounter() : -1;
}
