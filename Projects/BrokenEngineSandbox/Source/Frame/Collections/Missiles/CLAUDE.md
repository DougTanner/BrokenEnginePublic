...
- **Two-phase homing**: An initial boost ramps rotation strength from zero to full over a short delay; active tracking then orients toward the target with exponential smoothing. Falls back to the stored direction when the target is lost.
