...
- **GamePacketType** (`GamePacketType.h`) - Game-layer enum extending `engine::PacketType` at `kGamePacketStart`. Defines all game-specific packet identifiers (assign player, player state, fleet operations, fleet sync)
