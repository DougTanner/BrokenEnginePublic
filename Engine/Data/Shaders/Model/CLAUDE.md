...
This directory contains PBR shaders for rendering models along with precomputation shaders for image-based lighting resources. The implementation follows industry-standard PBR techniques based on the glTF 2.0 specification, Google Filament documentation, and LearnOpenGL PBR Theory.
...
Final output uses ACES filmic tone mapping (Stephen Hill fit) with configurable exposure and gamma correction.
