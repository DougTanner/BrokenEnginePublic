...
- **Tone mapping**: ACES filmic (Narkowicz fit) with configurable exposure and gamma; IBL cubemap samples are tonemapped before linearization, and engine cubemaps are sampled in Y-up space (swizzled from Z-up world).
