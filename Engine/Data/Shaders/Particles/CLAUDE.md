...
- **LightingParticlesRender.vert/.frag** - Particle light contribution to the deferred directional lighting pass via MRT; marks the center tile's occupancy bit (dilation done by `LightOccupancyDilate.comp`)
