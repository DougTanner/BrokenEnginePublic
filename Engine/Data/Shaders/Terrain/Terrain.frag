...
void main()
{
	...
	{
		vec3 f3RockNormal = normalize(SampleNormal(globalLayout, rockNormalsSampler0, f3InPosition.xy + f3InPosition.z, globalLayout.fTerrainRockNormalsSizeOne, 0.0f, globalLayout.fDeltaTime, vec2(0.0f, 0.0f)) +
									  SampleNormal(globalLayout, rockNormalsSampler1, f3InPosition.xy + f3InPosition.z, globalLayout.fTerrainRockNormalsSizeTwo, 0.0f, globalLayout.fDeltaTime, vec2(0.0f, 0.0f)) +
									  SampleNormal(globalLayout, rockNormalsSampler2, f3InPosition.xy + f3InPosition.z, globalLayout.fTerrainRockNormalsSizeThree, 0.0f, globalLayout.fDeltaTime, vec2(0.0f, 0.0f)));
	...
	{
		vec3 f3BeachNormal = normalize(2.0f * SampleNormal(globalLayout, sandNormalsSampler0, f3InPosition.xy, globalLayout.fTerrainBeachNormalsSizeOne, 0.0f, globalLayout.fDeltaTime, vec2(0.0f, 0.0f)) +
									   0.5f * SampleNormal(globalLayout, sandNormalsSampler1, f3InPosition.yx, globalLayout.fTerrainBeachNormalsSizeTwo, 0.0f, globalLayout.fDeltaTime, vec2(0.0f, 0.0f)) +
									   1.0f * SampleNormal(globalLayout, sandNormalsSampler2, f3InPosition.yx, globalLayout.fTerrainBeachNormalsSizeThree, 0.0f, globalLayout.fDeltaTime, vec2(0.0f, 0.0f)));
