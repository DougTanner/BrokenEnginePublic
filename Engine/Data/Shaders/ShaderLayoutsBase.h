...
struct GltfMaterialLayout
{
	...
	vec4 baseColorFactor INIT;
	vec4 emissiveFactor INIT;
	vec4 diffuseFactor INIT;
	vec4 specularFactor INIT;
	float workflow INIT;
	float fPad1 INIT;
	float fPad2 INIT;
	float fPad3 INIT;
	int baseColorTextureSet INIT;
	int physicalDescriptorTextureSet INIT;
	int normalTextureSet INIT;
	int occlusionTextureSet INIT;
	int emissiveTextureSet INIT;
	int iPad1 INIT;
	int iPad2 INIT;
	int iPad3 INIT;
	float metallicFactor INIT;
	float roughnessFactor INIT;
	float alphaMask INIT;
	float alphaMaskCutoff INIT;
};
