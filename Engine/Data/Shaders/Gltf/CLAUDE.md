...
- **Gltf.frag** - Full PBR fragment shader with Cook-Torrance BRDF using metallic-roughness workflow, image-based lighting, and engine integration for directional lights, shadows, and smoke. Uses getUV() helper to select the appropriate UV channel per texture based on material texture set indices
