...
- Outputs must converge to exact zero after storage-format quantization. Decay and threshold choices must not create positive fixed points; occupancy is rebuilt from nonzero output, so residual values keep tiles active forever.
