...
- **LightCombine.comp** - Sums spread pass outputs across all three channels and tone maps float16 → UNORM8 using Uchimura curve. `fCombineHuePreserve` blends per-channel vs luminance-preserving modes
