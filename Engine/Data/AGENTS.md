# Engine Data - Shared Asset Inputs

Engine-owned source and intermediate assets consumed by DataPacker. Keep reusable engine content here; game-specific assets belong under the project Data root.
...
- Shader source has separate [shader guidance](Shaders/AGENTS.md).
