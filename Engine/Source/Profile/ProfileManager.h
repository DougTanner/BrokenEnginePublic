...
enum CpuCounters
{
	...
	kCpuCounterLights,
		kCpuCounterVisibleLightsRendered,
		kCpuCounterAreaLights,
		kCpuCounterAreaLightsRendered,
		kCpuCounterControlledPointLights,
...
inline CpuCounter gpCpuCounters[]
{
	...
	CpuCounter {.name = "    Visible rendered" },
	CpuCounter {.name = "    Area" },
	CpuCounter {.name = "    Area rendered" },
	CpuCounter {.name = "    Controlled point" },
	CpuCounter {.name = "    Point" },
