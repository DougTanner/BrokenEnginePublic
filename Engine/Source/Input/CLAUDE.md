...
- Focus gain registers the keyboard raw-input device and clears the keyboard scratch (stuck-key guard); focus loss unregisters it and freezes the snapshot rather than clearing — consumers keep last-known state. Gamepad suspend/resume mirrors focus.
