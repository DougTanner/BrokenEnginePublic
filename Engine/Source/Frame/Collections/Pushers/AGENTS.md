...
- **Carry-forward Update**: Interpolate `Update` is a plain memcpy of previous-frame values — pushers have no self-driven simulation; last-synced state stays valid until the owner re-syncs.
