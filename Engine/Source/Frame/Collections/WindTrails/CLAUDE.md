...
- `Render()` carries an extra `uiFrameId` parameter solely so it is excluded from the auto-generated `InterpolateRenderTypes` walk; unlike SmokeTrails, the parameter is unused here.
...
- [../WindRadials/CLAUDE.md](../WindRadials/CLAUDE.md) - Stationary sibling; same deposit shader and ping-pong scheme
