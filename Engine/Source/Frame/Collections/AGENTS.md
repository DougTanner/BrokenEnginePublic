...
- Deserialization validates count/capacity relationships, allocates for the incoming layout, and validates ID-map count and indices. Preserve these trust-boundary checks when formats change.
