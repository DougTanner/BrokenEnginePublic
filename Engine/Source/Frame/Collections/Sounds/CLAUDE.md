...
- **Position forced W=1 in `Sync`**: explicitly set rather than trusting the caller, so listener-distance math gets point semantics (root [CLAUDE.md](../../../../../CLAUDE.md) "XMVECTOR W invariant").
