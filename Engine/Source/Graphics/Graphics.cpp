...
void Graphics::Refresh()
{
	...
	if (bWorldDetailChanged) [[unlikely]]
	{
	...
	if (bLightingMultiplierChanged || bLightingBlurDownscaleChanged || bLightingCombineIndexChanged) [[unlikely]]
	{
	...
	if (bObjectShadowsRenderMultiplierChanged || bObjectShadowsBlurMultiplierChanged) [[unlikely]]
	{
		gpTextureManager->CreateObjectShadowsTextures();
		game::gpGltfPipelines->CreateGltfShadowPipelines();
		gpPipelineManager->CreateLightingShadowDependantPipelines();
	...
	if (gpInstanceManager != nullptr) [[likely]]
	{
		...
		if (gpInstanceManager != nullptr && bTerrainElevationTextureMultiplierChanged) [[unlikely]]
		{
		...
		if (gpInstanceManager != nullptr && bTerrainColorTextureMultiplierChanged) [[unlikely]]
		{
		...
		if (gpInstanceManager != nullptr && bTerrainNormalTextureMultiplierChanged) [[unlikely]]
		{
		...
		if (gpInstanceManager != nullptr && bTerrainAmbientOcclusionTextureMultiplierChanged) [[unlikely]]
		{
		...
		if (gpInstanceManager != nullptr && (bSmokeTrailPowerChanged || bSmokeTrailAlphaChanged || bSmokeSimulationPixelsChanged || bSmokeSimulationAreaChanged)) [[unlikely]]
		{
