...
- Pipeline descriptor registrations contain raw pipeline back-references. They remain valid until a complete `PipelineManager` rebuild; destroying one pipeline does not unregister it.
...
- [Graphics](../AGENTS.md) - Renderer frame and recreation lifecycle
