...
- **Wind**: Time & Global (time scale), Propagation (advection, swirl scale/amount/speed, vorticity confinement, decay high/low, momentum high/low, threshold low/high/power, diffusion)
