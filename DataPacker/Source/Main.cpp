...
void RunExportJobs()
{
	...
	// DT: TEMP CRCs
	// temporaryHeaderFileStream << std::endl;
	// headerTempFileStream << "inline constexpr int64_t kiTextureCount = " << textureCrcs.size() << ";" << std::endl;
	// headerTempFileStream << "inline constexpr common::crc_t kpTextureCrcs[] = " << std::endl;
	// headerTempFileStream << "{" << std::endl;
	// for (const common::crc_t& rCrc : textureCrcs)
	// {
	// 	headerTempFileStream << rCrc;
	// 	headerTempFileStream << ", ";
	// }
