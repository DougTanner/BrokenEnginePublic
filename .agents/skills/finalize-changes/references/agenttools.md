...
exhaustive canonical shared-artifact trigger; ordinary Git changes, Markdown in
...
same canonical binaries. When a change here could break another live worktree —
...
The summary states that landing replaces the canonical AgentTools binaries
...
retryable quiescence applies, or rollback failed with its named backup.
