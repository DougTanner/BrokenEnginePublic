...
- Read [RenderDoc capture](references/renderdoc.md) only for a GPU frame-capture or capture-analysis scenario; it owns the `--renderdoc` launch, `renderdoc_capture`, and the headless `rdc_*` analysis scripts.
