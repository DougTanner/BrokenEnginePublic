...
- Preserve canonical approval and landing semantics, WorktreeCli-only scheduler mutation, live-claim rules, exact-primary-mutation confirmation, and receipt/sidecar ownership.
...
- `.agents/references/subagent-reporting.md` and the execution-gate, claim, receipt, and landing references consumed by those skills.
...
- A static sweep proves core main-session contracts assign no task-evidence inspection, edit, build, test, review, Plan-claim, Git, reconciliation, or landing mechanics to the main.
