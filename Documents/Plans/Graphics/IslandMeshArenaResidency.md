...
- `Engine/Source/CLAUDE.md` / `Engine/Source/Frame/CLAUDE.md` / `Engine/Source/Graphics/CLAUDE.md` — boot-order, mesh-residency, and record-once-CB documentation updates.
...
- `Engine/Source/CLAUDE.md` / `Frame/CLAUDE.md` / `Graphics/CLAUDE.md` updated to reflect arena mesh residency and the relaxed boot-order invariant.
