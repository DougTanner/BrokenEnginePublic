...
- Shares `CommandBufferRecordMain.cpp` with `Refactor_CommandBufferRecordDedup`, `WindowedLightingShadowDispatch`, `LightingSpreadEmptySkipCadence`, `DisabledPassGatingPerfAudit`, `ObjectShadowsPassCost` — co-schedule or refresh citations (File Group).
