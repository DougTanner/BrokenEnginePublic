...
|---|------|------|--------|--------|-------|-------|-------|
| 1 | [Engine/AudioSet3dSettingsCleanup.md](Engine/AudioSet3dSettingsCleanup.md) | Quick Win | 1 | 2 | 1 | 0 | Collapse `Set3dSettings` to just `mfManualFadeVolume` (or promote that to a 4-wrapper height-lerped quartet matching the other three). Delete now-dead `mfManualFadeStart`/`mfManualFadeEnd` members. Update single caller `Game.cpp:58`. Follow-up to the Sound > Tweaks sub-tab change. |
