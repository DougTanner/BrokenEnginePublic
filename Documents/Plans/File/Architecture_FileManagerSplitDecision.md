...
1. In `Engine/Source/File/AGENTS.md`, under the `## FileManager` heading (before `### Eager vs Lazy`), add a short paragraph (2-3 sentences) stating:
...
- `Engine/Source/File/AGENTS.md` — the only file edited.
