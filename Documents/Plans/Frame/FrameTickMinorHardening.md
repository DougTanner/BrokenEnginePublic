...
- `Projects/BrokenEngineSandbox/Source/Frame/FrameTick.cpp` + `Projects/BrokenEngineSandbox/Source/Network/Server/ServerSession.cpp` (`ServicePausedNetwork`) + `Engine/Source/Frame/FrameBase.h` (`FrameStaticData` built-flag, item 1 — both gate call sites)
