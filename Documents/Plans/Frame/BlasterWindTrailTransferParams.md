...
Either way, correct the Blasters CLAUDE.md handoff claim to match the landed behavior.
...
- `Projects/BrokenEngineSandbox/Source/Frame/Collections/Blasters/CLAUDE.md` — handoff claim
