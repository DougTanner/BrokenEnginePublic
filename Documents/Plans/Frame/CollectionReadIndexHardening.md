...
- Never interleave with the live frame-collection series `Documents/Plans/Frame/Architecture_CollectionHelperDedup.md`, `Documents/Plans/Frame/Architecture_PhaseHookOptIn.md`; each later landing must refresh shared collection-header/TU citations.
...
- Shares `Engine/Source/Frame/Collections/Collection.h` with the live Frame-collections series (`Frame/Architecture_CollectionHelperDedup.md`, `Frame/Architecture_PhaseHookOptIn.md`) — co-schedule / refresh citations; touches the client full-state receive path shared with the Network full-state plans.
