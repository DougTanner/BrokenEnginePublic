...
- Frame version/save/replay batch with `Documents/Plans/Frame/TransferSentinelConflation.md` and `Documents/Plans/Frame/PlayerTransferUuidPreservation.md`: co-land behind one consolidated `Frame::kiVersion` change and one save/replay invalidation; the last lander owns the bump.
