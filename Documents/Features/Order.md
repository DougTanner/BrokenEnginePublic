...
- **`.agents/skills/agent-harness/SKILL.md`**: `Agent/AgentQueryGlobalState.md` extends command documentation; cross-queue `Documents/Plans/Agent/PrivateLanFirewallRule.md` adds opt-in Windows firewall setup guidance. Disjoint sections; later lander preserves both changes and runs harness verification.
