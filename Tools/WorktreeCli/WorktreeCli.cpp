...
namespace toolcli
{
	namespace
	{
		void PrintUsage(std::ostream& rOutput)
		{
			...
			rOutput << "       WorktreeCli.exe plan order complete --repo COMMON-DIR --worktree CHECKOUT --owner TOKEN --session TOKEN --plan PATH [--reapply] [--plans-order PATH] [--features-order PATH]\n";
